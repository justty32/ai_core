...
留空＝取 `workflows/ideas/notes/` 最新一份。先決定要擴展哪一份 `workflows/ideas/notes/<slug 檔>`。
...
```bash
python3 sub_projs/ver_1/try_implement/tools/idea.py expand < workflows/ideas/notes/<slug 檔> \
