...
| [sub_projs/](sub_projs/README.md) | 半獨立子專案：`ver_1/`（★ 封存的最早 Python 實作版＝src＋tests＋try_implement〔含 core_handy〕＋examples＋pyproject＋archive/〔早期歷史留存：thinking/、舊 overview.html、progress.md、architecture_docs/〕，僅供參考、不精整）、`llm_forge/`（galgame 台詞生成器規劃，第一目標問題）。入口 [sub_projs/README.md](sub_projs/README.md) |
