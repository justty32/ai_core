"""output.py — core.ask 的四個出口回呼打包成 Sink（對齊 core/src/cli_output.cpp 的 Sink）。
...
class Sink:
    """core.ask 的 handlers 與其共享狀態。把 sink.on_* 綁定方法傳給 core.ask 的對應回呼。"""
