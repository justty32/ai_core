...
| [`try_3/`](try_3/README.md) | 玩具實驗場③：**純 C++／C++20 modules**（CMake + Ninja + vcpkg + MinGW + VSCode/gdb；不嵌腳本 VM）。已長：glaze 反射 JSON、native HTTP 傳輸模組 `http.cppm`（WinHTTP/libcurl，file:// 離線 fixture）|
