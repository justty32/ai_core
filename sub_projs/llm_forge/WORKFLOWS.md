...
- **idea 階段的礦脈在主專案** `ai_core/workflows/notes/`——尤其 [20260713-0956-galgame台詞生成-第一目標問題-llm_forge.md](../../workflows/notes/20260713-0956-galgame台詞生成-第一目標問題-llm_forge.md)（本子專案的唯一內容來源，標〔待續〕，還會被後續討論擴充）。
