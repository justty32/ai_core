# 軸 5 resources — 封存：被 supersede 的舊輪次（Round 1–2）

> 封存（2026-06-28 收斂）。含被砍掉的 cpu 欄位等舊提案，保留 WHY，**非現況**。現況見 [`../axis_5_resources.md`](../axis_5_resources.md) 與事實基準 `defs/axes.hpp`。
